  ...
  return (
    <nav className="bg-white shadow-sm relative z-50">
      ...
      <div className="md:hidden" ref={mobileMenuRef}>
        ...
        {/* 모바일 드롭다운 메뉴 */}
        {isMobileMenuOpen && (
          <div className="bg-white border-t border-gray-100 animate-in fade-in slide-in-from-top-2">
                  ...
                  {item.disabled || item.mobileDisabled ? (
                    ...
                    >
                      ...
                      {item.mobileDisabled && showTooltip && (
                        <div className="absolute top-full left-3 mt-1 bg-[#15171a] text-white text-sm px-3 py-2 rounded-md whitespace-nowrap z-10 animate-in fade-in slide-in-from-top-2">
