                  ...
                  {item.disabled || item.mobileDisabled ? (
                    ...
                    >
                      ...
                      {item.mobileDisabled && showUploadTooltip && (
                        <div className={`absolute top-full left-24 mt-1 bg-[#15171a] text-white text-sm px-3 py-2 rounded-md whitespace-nowrap z-50 text-left ${
                      ...
                      {item.disabled && showFinderTooltip && (
                        <div className={`absolute top-full left-12 mt-1 bg-[#15171a] text-white text-sm px-3 py-2 rounded-md whitespace-nowrap z-50 text-left ${
